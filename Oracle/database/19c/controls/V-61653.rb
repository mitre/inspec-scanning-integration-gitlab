control 'V-61653' do
  ...
  OS level."
    ...
    describe 'A manual review is required to ensure the system protects audit information from any type of
  unauthorized access.' do
    skip 'A manual review is required to ensure ensure the system protects audit information from any type of
  unauthorized access.'
  end
end
