...
control 'V-CIS6213' do
  title 'The ALTER CREATE DATABASE LINK Audit Option Is Enabled'
  desc  "Oracle database links are used to establish database to database connections to other databases.  Enable Database Link Audit creates logging of all ALTER Database and ALTER Public Database statements"
  desc  'rationale', ''
  desc  'check', "
    From SQL*Plus:
