control 'V-61867' do
  ...
  describe 'The system must verify there have not been unauthorized changes to the DBMS software and information by manual examination or interview at this time.' do
    skip 'The system must verify there have not been unauthorized changes to the DBMS software and information by manual examination or interview at this time.'
  end
end
