...
oracle_home = command('echo $ORACLE_HOME').stdout.strip
 ...
 describe 'Determining if the use of the external procedure agent is authorized by manual examination or interview at this time.' do
    skip 'Determining if the use of the external procedure agent is authorized by manual examination or interview at this time.'
  end
