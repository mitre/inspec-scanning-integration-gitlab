...
control 'V-CIS627' do
  title 'The GRANT Audit Option Is Enabled'
  desc  "The GRANT statement ae used to grant privileges to Oracle database users and roles, including the most powerful privileges and roles typically available to the database admininstrators."
  desc  'rationale', ''
  desc  'check', "
    From SQL*Plus:
