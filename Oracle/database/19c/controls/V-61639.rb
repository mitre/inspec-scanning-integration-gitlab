control 'V-61639' do
  ...
  describe 'Verification for DBMS configuration using third-party product or custom code is deployed for Oracle Auditing must be performed by manual examination or interview at this time.' do
    skip ' Verification for DBMS configuration using third-party product or custom code is deployed for Oracle Auditing must be performed by manual examination or interview at this time.This test can only be performed by manual examinati    on or interview at this time'
  end
