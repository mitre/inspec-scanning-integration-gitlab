...
control 'V-CIS6214' do
  title 'The DROP CREATE DATABASE LINK Audit Option Is Enabled'
  desc  "Oracle database links are used to establish database to database connections to other databases.  Enable Database Link Audit creates logging of all DROP Database and DROP Public Database statements"
  desc  'rationale', ''
  desc  'check', "
    From SQL*Plus:
