...
control 'V-CIS625' do
  title 'The Alter Role Audit Option Is Enabled'
  desc  "The Alter Role is a collection or set of privileges that can be granted to users or other roles.  Roles may include system privileges, object privileges or other roles.  The ALTER ROLE statement is used to change the authorization needed to enable a role."
  desc  'rationale', ''
  desc  'check', "
    From SQL*Plus:
