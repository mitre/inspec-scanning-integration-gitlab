control 'V-61869' do
  ...
  describe 'A manual review is required the OS must limit privileges to change the DBMS software resident
  within software libraries (including privileged programs).' do
    skip 'A manual review is required to ensure the OS must limit privileges to change the DBMS software resident
  within software libraries (including privileged programs).'
  end
end
