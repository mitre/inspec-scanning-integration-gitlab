control 'V-61761' do
  ...
  describe 'Database data files containing sensitive information must be performed by manual examination or interview at this time.' do
    skip 'Database data files containing sensitive information must be performed by manual examination or interview at this time.'
  end
