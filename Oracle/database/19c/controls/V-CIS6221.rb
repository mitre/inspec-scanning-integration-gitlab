...
control 'V-CIS6221' do
  title 'The Alter PROCEDURE/FUNCTION/PACKAGE/PACKAGE BODY Is Enabled'
  desc  "The oracle database procedure, function, package and package bodies, which are stored in teh database are created to perform business functions and access database as defined by PL/SQL code and SQL statements contained within these objects.  Enabling this unified action audit causes logging of all ALTER PROCEDURE, ALTER FUNCTION, ALTER PACKAGE AND ALTER PACKAGE BODY statements. "
  desc  'rationale', ''
  desc  'check', "
