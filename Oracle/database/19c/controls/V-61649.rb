control 'V-61649' do
  ...
  describe 'The system must provide the capability to automatically process audit records for events of interest based upon selectable event criteria by manual examination or interview at this time.' do
    skip 'The system must provide the capability to automatically process audit records for events of interest based upon selectable event criteria by manual examination or interview at this time.'
  end
end
