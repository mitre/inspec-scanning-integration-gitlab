control 'V-61651' do
  ...
  describe 'A manual review is required to ensure attempts to bypass access controls must be audited.' do
    skip 'A manual review is required to ensure ensure attempts to bypass access controls must be audited.'
  end
end
