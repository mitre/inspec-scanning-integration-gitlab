control 'V-61759' do
  ...
  describe 'Verification for federally required cryptographic protections for the level of classification of the data must be performed by manual examination or interview at this time.' do
    skip 'Verification for federally required cryptographic protections for the level of classification of the data must be performed by manual examination or interview at this time.'
  end
