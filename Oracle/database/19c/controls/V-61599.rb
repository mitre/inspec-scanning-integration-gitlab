control 'V-61599' do
  ...
  beyond those required for administrative functions."
    ...
    describe 'A manual review is required to ensure The DBA role must not be assigned excessive or unauthorized
  privileges.' do
    skip 'A manual review is required to ensure The DBA role must not be assigned excessive or unauthorized
  privileges.'
  end
end
