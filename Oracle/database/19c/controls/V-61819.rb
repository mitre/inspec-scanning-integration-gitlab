control 'V-61819' do
  ...
  technique to verify password complexity."
   ...
   describe 'The DBMS must limit the use of resources by priority and not impede the host from servicing processes designated as a higher-priority by manual examination or interview at this time.' do
    skip 'The DBMS must limit the use of resources by priority and not impede the host from servicing processes designated as a higher-priority by manual examination or interview at this time.'
  end
end
