...
control 'V-CIS6217' do
  title 'The DROP SYNONYM Audit Option Is Enabled'
  desc  "Oracle database synonym is used to create an alternative name for a database object such as table, view procedure java object or even another synonym. Enable the audit creas logs of all DROP SYNONYM AND DROP Public SYNONYM statements."
  desc  'rationale', ''
  desc  'check', "
    From SQL*Plus:
