control 'V-61683' do
  ...
  applications."
    ...
    describe 'A manual review is required to ensure the use of external executables must be authorized.' do
    skip 'A manual review is required to ensure the use of external executables must be authorized.'
  end
end 
