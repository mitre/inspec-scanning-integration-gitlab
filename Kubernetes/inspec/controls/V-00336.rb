...
control 'V-00336' do
    title 'The application must use a FIPS-validated cryptographic module to provision digital signatures.'
    ...
    tag gid: 'V-00336'
    tag rid: ''
    tag stig_id: 'SRG-APP-000630'
    tag fix_id: ''
    tag cci: ['CCI-002450']
    tag nist: ['SC-13']

    describe 'This check is Not Applicable.' do
        skip 'Not Applicable: Provisioning digital signatures are outside the Kubernetes scope.'
    end
end