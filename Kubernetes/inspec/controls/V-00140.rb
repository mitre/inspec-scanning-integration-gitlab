...
control 'V-00140' do
    ...
    desc  'fix', "Edit the Kubernetes etcd manifest file in the /etc/kubernetes/manifests directory on the Kubernetes Master Node.  Set the value of --cert-file to the Approved Organizational Certificate."
    impact 0.5
    tag severity: 'medium'
