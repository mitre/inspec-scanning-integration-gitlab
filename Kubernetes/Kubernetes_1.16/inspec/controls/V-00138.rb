...
control 'V-00138' do
    ...
    desc  'fix', "Edit the Kubernetes etcd manifest file in the /etc/kubernetes/manifests directory on the Kubernetes Master Node.  Set the value of --peer-client-cert-auth true for the etcd."
    impact 0.5
    tag severity: 'medium'
    ...
    describe file('/etc/kubernetes/manifests/etcd-main.manifest') do
        its('content') { should match 'peer-client-cert-auth' }
    end
end