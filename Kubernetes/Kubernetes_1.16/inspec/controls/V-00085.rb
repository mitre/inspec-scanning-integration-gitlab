...
control 'V-00085' do
    ...
    Port:
	Review the information systems documentation and interview the team, gain an understanding of the Controller architecture, and determine applicable ports, protocols, and services (PPS).  Any ports, protocols, and services not set in the system documentation is a finding.
	Review findings against the most recent PPSM Category Assurance List (CAL):
    https://cyber.mil/ppsm/cal/
	Verify Controller network boundary with the ports, protocols and services associated with the Controller for Assurance Categories.  Any ports, protocols, and services not in compliance with the CAL Assurance Category requirements is a finding."
    desc  'fix', "Amend any system documentation requiring revision.   Update Kubernetes Controller manifest to comply with PPSM CAL ports, protocols, and services."
    impact 0.5
    tag severity: 'medium'
