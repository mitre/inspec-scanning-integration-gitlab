...
control 'V-00133' do
	...
	more kubelet
    --client-ca-file 
	If the setting feature client-ca-file is not set in the Kubernetes API server mainifest file or contains no value, this is a finding."
    ...
    describe bash('cd /etc/sysconfig/ && sudo grep -i client-ca-file *') do
