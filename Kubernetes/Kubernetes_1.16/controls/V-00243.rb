...
control 'V-00243' do
    title 'Applications that perform address resolution services must perform data integrity verification on the name/address resolution responses the system receives from authoritative sources.'
