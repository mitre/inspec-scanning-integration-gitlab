...
control 'V-00031' do
    ...
    desc  'rationale', ''
    desc  'check', "Log into the each worker node.  Verify that the sshd service is not running.  To validate that the service is not running, run the command:
    ...
    describe bash('systemctl status sshd | grep Active') do
