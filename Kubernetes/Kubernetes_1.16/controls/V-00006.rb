...
control 'V-00006' do
	...
	If the setting tls-min-version is not set in the Kubernetes Controller Manager manifest file or it is set to VersionTLS10 or VersionTLS11, this is a finding."
    desc  'fix', "Edit the Kubernetes Controller Manager manifest file in the /etc/kubernetes/manifests directory on the Kubernetes Master Node.  Set the value of --tls-min-version to either VersionTLS12 or VersionTLS13."
    impact 0.5
    tag severity: 'medium'
