...
control 'TCAT-AS-000790' do
    ...
    applications that run on Tomcat. By default, the manager application is only
    accessible via the localhost. Exposing the management application to any
    ...
    $CATALINA_HOME/webapps/manager/META-INF/context.xml file.
    ...
    the Tomcat web site for specific details and additional configuration options.
    ...
    tag fix_id: 'F-TCAT-AS-000790_fix'
    tag cci: ['CCI-001082']
    tag nist: ['SC-2']
