...
control 'TCAT-AS-000220' do
    ...
    server by using the $Host element. This allows the admin to separate hosted
    applications according to where the domain the application will be available.
    Configuring logs on a per-host basis allows for log management that correlates
    to the virtual host activity.'
    desc  'rationale', ''
    desc  'check', '
    ...
    tag fix_id: 'F-TCAT-AS-000220_fix'
    tag cci: ['CCI-000130']
    tag nist: ['AU-3']
