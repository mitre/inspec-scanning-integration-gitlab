...
control 'TCAT-AS-000410' do
    ...
    running Tomcat under Docker can impact how file permissions and user ownership
    settings are applied. Due to associated Docker configuration complexities, the
    STIG is scoped for standalone rather than virtual deployments.'
    desc  'rationale', ''
    desc  'check', '
    ...
    tag fix_id: 'F-TCAT-AS-000410_fix'
    tag cci: ['CCI-001495']
    tag nist: ['AU-9']
