...
control 'TCAT-AS-000700' do
    ...
    OS, by default Tomcat uses the \'cacerts\' file as the CA trust store. The file
    is located in the /etc/ssl/certs/java/ folder with a link to the file in
    $JAVA_HOME/lib/security/cacerts. However, this location can be modified by
    ...
    tag fix_id: 'F-TCAT-AS-000700_fix'
    tag cci: ['CCI-000185']
    tag nist: ['IA-5 (2) (a)']
